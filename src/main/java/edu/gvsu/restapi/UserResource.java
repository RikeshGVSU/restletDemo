...
public class UserResource  extends ServerResource {
	...
	private RegistrationInfo rInf = null;
	...
	public void doInit() {
	    ...
	    this.rInf = ObjectifyService.ofy()
	        .load()
	        .key(theKey)
	        .now();
	...
	public Representation get(Variant variant) throws ResourceException {
		...
		if (null == this.rInf) {
			...
			if (variant.getMediaType().equals(MediaType.APPLICATION_JSON)) {
				result = new JsonRepresentation(this.rInf.toJSON());
			} else {
				result = new StringRepresentation(this.rInf.toHtml(false));
		...
		throws ResourceException
	{
        ...
        ObjectifyService.ofy()
            ...
            .now();
				...
				rep = new JsonRepresentation(this.rInf.toJSON());
				getResponse().setEntity(rep);
